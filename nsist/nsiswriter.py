...
class NSISFileWriter(object):
    ...
    def __init__(self, template_file, definitions=None):
        ...
        :param dict definitions: Mapping of name to value (values will be
                                 quoted)
        """
    ...
    def write_extra_files_install(self, f, indent):
        """Write the commands to install the list of extra files and
        directories.
    ...
    def write_extra_files_uninstall(self, f, indent):
        """Write the commands to uninstall the list of extra files and
        directories.
